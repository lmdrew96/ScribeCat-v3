    ...
    <div className="flex h-full flex-col p-2 gap-2">
      ...
      <div className="flex items-center gap-3 rounded-lg bg-card p-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="font-mono text-lg font-medium text-foreground">{formatTime(recordingTime)}</div>
        ...
        {isRecording && (
          <Button variant="secondary" size="sm" onClick={handlePauseResume} className="gap-1.5 h-8 px-2 text-xs">
            {isPaused ? (
              <>
