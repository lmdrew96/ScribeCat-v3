...
import { Palette, Mic, BookOpen, User, Info, Check, ExternalLink, Github, Bug } from "lucide-react"
...
const themes = [
  ...
  { id: "high-contrast-dark", name: "HC Dark", colors: ["#000000", "#171717", "#ffffff", "#fbbf24"] },
  { id: "high-contrast-light", name: "HC Light", colors: ["#ffffff", "#f5f5f5", "#000000", "#2563eb"] },
]
                      ...
                      >
                        ...
                        <div className="flex gap-1">
                          {theme.colors.map((color, i) => (
                            <div key={i} className="rounded-sm w-4 h-4 border border-card-foreground" style={{ backgroundColor: color }} />
                          ))}
                        </div>
            ...
            {activeCategory === "about" && (
              <div className="space-y-5">
                ...
                <p className="text-sm text-muted-foreground">
                  Your ADHD-friendly lecture companion. Take notes, record lectures, and study smarter.
                </p>
                ...
                <div className="pt-4 border-t border-border">
                  <p className="text-xs text-muted-foreground">Made with love for distracted minds everywhere.</p>
                </div>
              </div>
            )}
          </div>
