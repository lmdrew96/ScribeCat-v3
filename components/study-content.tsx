      ...
      <Tabs defaultValue="transcript" className="h-[calc(100%-2.5rem)]">
        ...
        <TabsContent value="transcript" className="h-[calc(100%-2rem)] mt-0">
          <ScrollArea className="h-full rounded-lg bg-card p-3">
            <p className="whitespace-pre-wrap leading-relaxed text-xs text-foreground/90">{recording.transcript}</p>
          </ScrollArea>
        </TabsContent>

        <TabsContent value="notes" className="h-[calc(100%-2rem)] mt-0">
          <ScrollArea className="h-full rounded-lg bg-card p-3">
            <p className="whitespace-pre-wrap leading-relaxed text-xs text-foreground/90">{recording.notes}</p>
          </ScrollArea>
        </TabsContent>
      </Tabs>
    </div>
