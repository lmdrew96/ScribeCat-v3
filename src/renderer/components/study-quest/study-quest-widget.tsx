      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-[var(--glass-border)]">
        ...
        <div className="flex items-center gap-0.5 shrink-0">
          ...
          >
            ...
            <span className="sr-only">Open Study Quest</span>
          </Button>
          <Button
            variant="ghost"
            size="icon"
          ...
          >
            ...
            <span className="sr-only">Customise your cat</span>
          </Button>
          <Button
            variant="ghost"
            size="icon"
            ...
            title="Collapse Study Quest"
          >
            <ChevronDown className="h-3.5 w-3.5" />
            <span className="sr-only">Collapse Study Quest</span>
          </Button>
        </div>
      </div>
